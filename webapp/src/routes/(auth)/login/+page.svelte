...
<svelte:head>
	<title>Log In | The Solarpunk Almanac</title>
</svelte:head>
...
<div class="min-h-screen flex items-center justify-center px-4 py-12">
	<div class="w-full max-w-md">
			...
			<form on:submit|preventDefault={handleSubmit} class="space-y-4">
				...
				<div class="flex items-center justify-between">
					<label class="flex items-center gap-2 cursor-pointer">
						<input type="checkbox" class="rounded accent-solarpunk-teal" />
						<span class="text-sm text-slate-400">Remember me</span>
					</label>
					<a href="/forgot-password" class="text-sm text-solarpunk-teal hover:underline">
						Forgot password?
					</a>
				</div>
		...
		<p class="text-center text-sm text-slate-500 mt-6">
			...
			<a href="/signup" class="text-solarpunk-teal hover:underline">Sign up</a>
		</p>
	</div>
</div>
